...
import { ArrowLeft, TrendingUp, Mail, Clock, AlertCircle } from 'lucide-react';
...
export function AgencyDetail({ agency, users, onBack }: AgencyDetailProps) {
  ...
  // Calculer les stats globales de l'agence
